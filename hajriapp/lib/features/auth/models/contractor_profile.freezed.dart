...
class _$ContractorProfileImpl implements _ContractorProfile {
  ...
  @override
  String toString() {
    return 'ContractorProfile(id: $id, fullName: $fullName, companyName: $companyName, phone: $phone, language: $language, currency: $currency, avatar: $avatar, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
