                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        trailing: locale == 'en' ? const Icon(Icons.check, color: AppColors.primary) : null,
                        onTap: () => changeLanguage('en'),
                      ),
                      const Divider(height: 1),
                      ListTile(
                        title: const Text('ગુજરાતી (Gujarati)'),
                        trailing: locale == 'gu' ? const Icon(Icons.check, color: AppColors.primary) : null,
                        onTap: () => changeLanguage('gu'),
                      ),
                      const Divider(height: 1),
                      ListTile(
                        title: const Text('हिन्दी (Hindi)'),
                        trailing: locale == 'hi' ? const Icon(Icons.check, color: AppColors.primary) : null,
